...
class BarangController extends Controller
{
    ...
    {
        $barangs = BarangModel::select('barang_id', 'kode_barang', 'barang_nama', 'kategori_id', 'harga_beli', 'harga_jual')
            ->with('kategori');
        // 
    ...
    {
        $request->validate([
            'kode_barang'   => 'required|string|min:3|unique:m_levels,level_kode',
